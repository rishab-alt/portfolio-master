            ...
            <div className="p-4">
              ...
              <div className="mt-4">
                <p className="text-base text-gray-300">
                  In this unit, we explore the use of computer hardware within
                  technology systems. We go through the steps to plan the
                  installation for a fake technology company, install and
                  maintain the system for the fake business, and write a review.
                </p>
              </div>
            </div>
          </div>
